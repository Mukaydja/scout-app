...
# Upload image filigrane
uploaded_image = st.file_uploader("Ajouter une image filigrane (PNG recommandé) pour le rapport", type=["png"])
...
def create_pdf():
    ...
    if uploaded_image:
        try:
            ...
            pdf.image(tmp_img_path, x=10, y=10, w=190, h=277)
